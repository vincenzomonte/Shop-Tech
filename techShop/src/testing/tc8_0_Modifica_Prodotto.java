...
UpdateProdotto myServlet;
	...
	public void setUp() throws SQLException{
		...
		vend= new Venditore("Vincenzo","Password0#","Vincenzo","Montesano","vincenzomontesnao4@gmail.com","F","3415578614","Umberto1","Salerno","85100");
		model.addVenditore(vend);
		neg=new Negozio("AppleShop","Vincenzo","left","Verde","11111111112","2019-05-01","Pacifico nasce nel 1920, a Herzogenaurach","senerchia","casagiove","81023","images/negozi/Pacifico/Pacifico.png");
		modeln.addNegozio(neg);
		cat=new Categoria( "AppleShop",  "telefono", "path/telefono",  "descrizione");
		modelc.addCategoria(cat);
		prod= new Prodotto(11111,"AppleShop","telefonjo","Apple12",22,"images/negozi/Pacifico/500.jpg",10.5f,4,23,"Molto di più di un semplice iPhone");
	...
	public void tearDown() throws SQLException {
		model.deleteVenditore("Vincenzo");
	}
	...
	public void tc_8_0_1() throws IOException, ServletException, SQLException {
		...
		int id= modelp.getIDProd("AppleShop","telefono","iPhone");
	...
	public void tc_8_0_2() throws IOException, ServletException, SQLException {
		...
		int id= modelp.getIDProd("Apple","telefono","iPhone");
		System.out.println(id);
		Collection<Prodotto>prodotti;
		prodotti=modelp.getAllProductBySellerCategory(vend.getUsername(), cat.getNomeCategoria());
		when(request.getSession()).thenReturn(session);
