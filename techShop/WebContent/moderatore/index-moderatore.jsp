...
<%@include file="../WEB-INF/utilities/checkLoginMod.jsp" %>
        ...
        <header>
           <%@ include file="../WEB-INF/fragment/headeradmin.jsp" %>
            ...
            <div id='mySidenav' class="sidenav">
              <ul >
                <li  onclick="window.open('index-moderatore-venditori.jsp','_self')">
                    Venditori Reclami
                </li>
                <li  onclick="window.open('index-moderatore-clienti.jsp','_self')">
                    Clienti Reclami
                </li>
              ...
              <div class="wrapper" id="#ContentWrapper">
                    ...
                    <div class="categorySeller">
                          <div class="img">
                            ...
                            <div class="reclami">
                              <a href='reclami-negozio.jsp?negozio=<%= bean.getNomeNegozio() %>&venditore=<%= bean.getUsernameVenditore() %>'><img src='../images/modify.png'></a>
                          </div>
