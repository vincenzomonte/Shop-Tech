...
<%
	...
	Collection<ClienteBean>  clienti= model.getAllCliente();
%>
<!DOCTYPE html>
<html>
    <head>
                  ...
                  <%
                   ...
                   <div class="categorySeller">
                        <form action='' method='POST'>
                          ...
                          <div class="mod">
                              <a href='modifica-cliente.jsp?username=<%= bean.getUsername() %>'><img src='../images/modify.png'></a>
                          </div>
                          <div class='del'>
                            <span>
                              <a href=''><img onclick="deleteCliente('<%= bean.getUsername() %>')" style="cursor:pointer;" src='../images/delete.png'></a>
                            </span>
                          </div>
