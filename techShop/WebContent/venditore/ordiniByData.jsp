...
<%
	...
	if (venditore!=null){
		...
		if(negozio!=null){
			riferimenti= model.getArrayRiferimentoDataInizioFine(dateFrom, dateTo, negozio.getNomeNegozio());
...
<link rel='stylesheet' type='text/css'
	href='../css/sidenav-nav_left/stile-nav_left.css'>
<link rel='stylesheet' type='text/css'
	href='../css/sidenav-nav_left/sidenav-nav_left.css'>
...
<body onresize='resize()' id='home'>
	...
	<header>
		...
		<div id='mySidenav' class="sidenav">
			<ul>
				<li onclick="window.open('index-venditore.jsp','_self')">Il Mio
					Negozio</li>
				<li onclick="window.open('ordini.jsp','_self')">Tutti gli
					Ordini</li>
				<li onclick="window.open('formCliente.jsp','_self')">Ordini per
					Clienti</li>
				<li onclick="window.open('formData.jsp','_self')">Ordini per
					Data</li>
			</ul>
		</div>
	</header>
	<div class="content">
		...
		<br>
		<center>
			<h2>Ordini Ricevuti Per Data</h2>
		</center>
		<br>
			...
			<table style="max-width: 80%;">
				...
				<tbody>
					<tr>
						...
						<td data-label="Prodotto"><img height="45px"
							src="../<%= model.getPathByID(r.getId_prodotto()) %>"><br>cod.
							<%= r.getId_prodotto() %></td>

						<td data-label="Destinazione"><br><%=r.getFatturaRiferimento().getCittaDestinazione() %>,
							<%=r.getFatturaRiferimento().getViaDestinazione() %>, (<%=r.getFatturaRiferimento().getCapDestinazione() %>)</td>
		...
		<br>
		<h3>Non ci sono ordini da parte degli utenti della piattaforma!</h3>
		<%}
