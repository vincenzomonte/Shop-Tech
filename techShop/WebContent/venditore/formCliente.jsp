...
<body onresize='resize()' id='home'>
	...
	<div id='vendi' style='padding-top: 10px;'>
		<br>
		<br>
		<form id="regForm1" name="regForm1" action="./ordiniByClient.jsp"
			method="post" style='margin: 0 auto;'>
			<h2>
				<center>Ricerca fatture per cliente</center>
			</h2>
			...
			<div class="tab1">
				...
				<table>
					<tr>
						<td><label for="">Username Cliente</label></td>
					</tr>
					<tr>
						<td><input type="text" name="username"
							placeholder="inserisci username cliente..."></td>
					</tr>
