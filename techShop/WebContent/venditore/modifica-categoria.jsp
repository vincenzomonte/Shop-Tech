...
<body onresize='resize()' id='home'>
	...
	<div id='vendi' style='padding-top: 10px;'>
		<br>
		<br>
		<form id="regForm1" name="regForm1" action="../UpdateCategoria"
			method="POST" style='margin: 0 auto;'>
			<!--Fase di realizzazione-->
			<h2>
				<center>Modifica categoria</center>
			</h2>
			...
			<div class="tab1">
				<table>
					...
					<tr>
						<td><label for="Name:">Categoria </label></td>
						<td><input type="text" name="nomeCategoria"
							value='<%=nomeCategoria %>' placeholder=" Nome Categoria..."
							readonly></td>
					...
					<tr>
						...
						<td><input type="text" name="descCategoria"
							onblur="isText(document.regForm1.descCategoria)"
							value="<%= bean.getDescrizione() %>"
							placeholder=" Descrizione Categoria.."></td>
						<td>
							<div class="tooltip">
								<img class="imageInfo" src="../images/info.png" width="20px">
								<span class="tooltiptext"> Descrizione categoria formato:<br>
									min 10 mac 500 caratteri
								</span>
							</div>
						</td>
					</tr>
