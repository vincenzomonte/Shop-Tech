	...
	<header>
		...
		<div id='mySidenav' class="sidenav"  style="background-color:#50c878;">
			<ul>
				...
				<li  onclick="window.open('Reclamo.jsp','_self')">
	...
	<div class="content">
		...
		<div class="wrapper" id="#ContentWrapper">
			...
			<div class="category">
				<div class="img">
					<a
						href='index-cliente-categorie.jsp?negozio=<%= bean.getNomeNegozio() %>'><img
						title="<%= bean.getDescrizione() %>"
						src="../<%= bean.getLogo() %>"></a>
				</div>

				<a
					href='index-cliente-categorie.jsp?negozio=<%= bean.getNomeNegozio() %>'>
					<div class='nomeCategoria'>
						<span> <%= bean.getNomeNegozio() %>
						</span>
					</div>
				</a>
