<%@ page language="java" contentType="text/html; charset=UTF-8"
	import="javax.servlet.*,java.util.*,model.*" pageEncoding="UTF-8"
	session="true"%>
...
<body onresize='resize()' id='home'>
	...
	<div class="content">
		...
		<h2>
			<a href='index-cliente.jsp'>Negozi</a>/Categorie
		</h2>
		...
		<div class="wrapper" id="#ContentWrapper">
			...
			<div class="category">
				<div class="img">
					<a
						href='index-cliente-prodotti.jsp?negozio=<%=negozio %>&categoria=<%= bean.getNomeCategoria() %>'><img
						title="<%= bean.getDescrizione() %>"
						src="../<%= bean.getPath() %>"></a>
				</div>

				<a
					href='index-cliente-prodotti.jsp?negozio=<%=negozio %>&categoria=<%= bean.getNomeCategoria() %>'>
