			...
			<table style='max-width: 80%;'>
				...
				<tbody>
					<tr>
						...
						<td data-label="Reclamo"><a href="Reclamo.jsp">RECLAMO</a><br></td>
						<td data-label="Corriere"><a href="legg.jsp">Corriere</a><br></td>
						<td data-label="AZ"><br>
						<img src="../images/print.png"
							style="cursor: pointer; width: 40px;"
							onclick="window.open('stampa.jsp?fattura=<%= f.getNumFattura() %>','_self')"></td>
				...
				<tbody>
					...
					<tr>
						<td data-label="Prodotto"><img height="45px"
							src="../<%= model.getPathByID(r.getId_prodotto()) %>"></td>
