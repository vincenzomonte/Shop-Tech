...
<body onresize='resize()' id='home'>
	...
	<div id='vendi' style='padding-top: 10px;'>
		<br>
		<br>
		<form id="regForm1" name="regForm1" action="./ordiniByData.jsp"
			method="post" style='margin: 0 auto;'>
			<h2>
				<center>Ricerca fatture per data</center>
			</h2>
			...
			<div class="tab1">
				...
				<table>
					<tr>
						<td><label for="">Data inizio</label></td>
						<td><input type="date" name="dateFrom"></td>
					</tr>
					<tr>
						<td><label for="">Data fine</label></td>
