		...
		<div class="wrapper" id="#ContentWrapper">
			...
			<div class="product">
				<form action='' method='POST'>
					...
					<div class='note'>
						<span> Prezzo <%= bean.getPrezzo() %>&euro;<br>
							Quantit&agrave; <%= bean.getQuantita() %>
						</span>
					</div>
					<div class="mod">
						<a
							href='modifica-prodotto.jsp?ID=<%= bean.getIdProdotto() %>&nomeNegozio=<%= bean.getNomeNegozio() %>&nomeCategoria=<%= bean.getNomeCategoria() %>'><img
							src='../images/modify.png'></a>
					</div>
					<div class='del'>
						<span> <a href=''><img
								onclick="deleteProd('<%= bean.getIdProdotto() %>')"
			...
			<div class="category">
				<div class="img">
					<a
						href='inserisci-prodotto.jsp?negozio=nomeNeg&categoria=<%= categoria %>'><img
						src="../images/plus.png"></a>
				</div>
				<div class='nomeCategoria'>
					<span> <a
						href='inserisci-prodotto.jsp?negozio=nomeNeg&categoria=nomeCategoria'><p></p>Inserisci
							nuovo prodotto</a>
					</span>
				</div>
			</div>
